...
export default function About() {
    ...
    return (
      <main className="container-sm">
        ...
        <p>In the loop is the perfect companion for your crochet and knit projects. You can track your projects, what you have in your yarn stash (coming soon), keep track of all your patterns in your Pattern Library (coming soon) and even explore new stiches in our Stitch Library (coming soon).</p>
